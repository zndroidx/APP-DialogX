...
import com.zndroid.dialogx.ad.animation.ValueAnimator;
...
public abstract class Keyframe implements Cloneable {
     ...
     * with no initial value must be used as part of an {@link }).
     ...
     * an {@link } first starts; keyframes without values are assigned values at
     ...
     * {@link } to use when calculating values between keyframes. The type is based
