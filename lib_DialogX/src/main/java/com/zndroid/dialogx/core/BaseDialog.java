package com.zndroid.dialogx.core;
...
public abstract class BaseDialog {
    ...
    private void showNow() {
        ...
        if (baseDialog instanceof BottomMenuDialog || baseDialog instanceof ShareDialog) {
        ...
        dialog.get().show(fragmentManager, "squareDialog");
        ...
        if (DialogSettings.systemDialogStyle == 0 && style == DialogSettings.STYLE.STYLE_IOS && !(baseDialog instanceof TipDialog) && !(baseDialog instanceof BottomMenuDialog) && !(baseDialog instanceof ShareDialog)) {
