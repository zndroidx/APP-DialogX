...
import com.zndroid.dialogx.view.NotifyToastShadowView;
...
public class Notification {
    ...
    private void showMaterialNotification() {
        ...
        rootView = (NotifyToastShadowView) inflater.inflate(R.layout.dialogx_layout_notification_material, null);
    ...
    private void showIOSNotification() {
        LayoutInflater inflater = (LayoutInflater) context.get().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rootView = (NotifyToastShadowView) inflater.inflate(R.layout.dialogx_layout_notification_ios, null);
    ...
    private void showSquareNotification() {
        LayoutInflater inflater = (LayoutInflater) context.get().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        rootView = (NotifyToastShadowView) inflater.inflate(R.layout.dialogx_layout_notification_square, null);
