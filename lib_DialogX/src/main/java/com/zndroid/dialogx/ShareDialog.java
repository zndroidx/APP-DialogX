...
import com.zndroid.dialogx.view.IOSItemImageView;
import com.zndroid.dialogx.view.TableLayout;
...
public class ShareDialog extends BaseDialog {
    ...
    public static ShareDialog build(@NonNull AppCompatActivity context) {
        synchronized (ShareDialog.class) {
            ...
            switch (shareDialog.style) {
                case STYLE_IOS:
                    shareDialog.build(shareDialog, R.layout.dialogx_layout_dialog_share_ios);
                    break;
                case STYLE_SQUARE:
                    shareDialog.build(shareDialog, R.layout.dialogx_layout_dialog_share_square);
                    break;
                case STYLE_MATERIAL:
                    shareDialog.build(shareDialog, R.layout.dialogx_layout_dialog_share_material);
                    break;
            }
            return shareDialog;
        }
    ...
    public void bindView(View rootView) {
        ...
        switch (style) {
            ...
            case STYLE_SQUARE:
                ...
                if (theme == DialogSettings.THEME.LIGHT) {
                    boxBody.setBackgroundColor(context.get().getResources().getColor(R.color.menuSplitSpaceSquare));
                    ...
                    boxBody.setBackgroundColor(context.get().getResources().getColor(R.color.squareDarkBkgColor));
            ...
            switch (style) {
                case STYLE_IOS:
                    if (items != null) {
                        ...
                        for (int i = 0; i < items.size(); i++) {
                            ...
                            View itemView = LayoutInflater.from(context.get()).inflate(R.layout.dialogx_item_share_ios, null);
                ...
                case STYLE_MATERIAL:
                    if (items != null) {
                        ...
                        for (int i = 0; i < items.size(); i++) {
                            final Item item = items.get(i);
                            final View itemView = LayoutInflater.from(context.get()).inflate(R.layout.dialogx_item_share_material, null);
                ...
                case STYLE_SQUARE:
                    if (items != null) {
                        ...
                        for (int i = 0; i < items.size(); i++) {
                            final Item item = items.get(i);
                            final View itemView = LayoutInflater.from(context.get()).inflate(R.layout.dialogx_item_share_square, null);
    ...
    public ShareDialog setStyle(DialogSettings.STYLE style) {
        ...
        switch (this.style) {
            case STYLE_IOS:
                build(this, R.layout.dialogx_layout_dialog_share_ios);
                break;
            case STYLE_SQUARE:
                build(this, R.layout.dialogx_layout_dialog_share_square);
                break;
            case STYLE_MATERIAL:
                build(this, R.layout.dialogx_layout_dialog_share_material);
                break;
        }
