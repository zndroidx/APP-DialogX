...
import com.zndroid.dialogx.view.ProgressView;
...
public class TipDialog extends BaseDialog {
    ...
    public static TipDialog build(AppCompatActivity context) {
        synchronized (TipDialog.class) {
            ...
            waitDialog.build(waitDialog, R.layout.dialogx_layout_dialog_wait);
            return waitDialog;
        }
    }
    ...
    public void refreshView() {
        if (rootView != null) {
            ...
            switch (tipTheme) {
                case LIGHT:
                    bkgResId = R.drawable.dialogx_rect_light;
                    int darkColor = Color.rgb(0, 0, 0);
                    blurFrontColor = Color.argb(DialogSettings.blurAlpha, 255, 255, 255);
                    ...
                    break;
                case DARK:
                    bkgResId = R.drawable.dialogx_rect_dark;
                    int lightColor = Color.rgb(255, 255, 255);
                    blurFrontColor = Color.argb(DialogSettings.blurAlpha, 0, 0, 0);
