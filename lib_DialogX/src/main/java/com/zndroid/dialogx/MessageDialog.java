...
import com.zndroid.dialogx.view.MaxHeightLayout;
...
public class MessageDialog extends BaseDialog {
    ...
    public static MessageDialog build(@NonNull AppCompatActivity context) {
        synchronized (MessageDialog.class) {
            ...
            switch (messageDialog.style) {
                case STYLE_IOS:
                    messageDialog.build(messageDialog, R.layout.dialogx_layout_dialog_select_ios);
                    break;
                case STYLE_SQUARE:
                    messageDialog.build(messageDialog, R.layout.dialogx_layout_dialog_select);
                    break;
                case STYLE_MATERIAL:
            ...
            switch (style) {
                case STYLE_IOS:
                    if (theme == DialogSettings.THEME.LIGHT) {
                        bkgResId = R.drawable.dialogx_rect_selectdialog_ios_bkg_light;
                        blurFrontColor = Color.argb(DialogSettings.blurAlpha, 244, 245, 246);
                    } else {
                        bkgResId = R.drawable.dialogx_rect_selectdialog_ios_bkg_dark;
                        ...
                        txtInput.setBackgroundResource(R.drawable.dialogx_editbox_dialog_bkg_ios_dark);
                        
                        btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_right_dark);
                        btnSelectOther.setBackgroundResource(R.drawable.dialogx_button_menu_ios_center_dark);
                        btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_left_dark);
                    }
                ...
                case STYLE_SQUARE:
                    if (theme == DialogSettings.THEME.DARK) {
                        ...
                        btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_gray_dark);
                        btnSelectOther.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_gray_dark);
                        btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_blue_dark);
        ...
        if (btnSelectNegative != null) {
            if (isNull(cancelButton)) {
                ...
                if (style == DialogSettings.STYLE.STYLE_IOS) {
                    ...
                    if (theme == DialogSettings.THEME.LIGHT) {
                        btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_light);
                    } else {
                        btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_dark);
                    }
                }
            } else {
            ...
            if (buttonOrientation == LinearLayout.VERTICAL) {
                ...
                if (style == DialogSettings.STYLE.STYLE_IOS) {
                    ...
                    if (okButtonDrawable == null && cancelButtonDrawable == null && otherButtonDrawable == null) {
                        if (theme == DialogSettings.THEME.LIGHT) {
                            btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_menu_ios_center_light);
                            if (btnSelectOther.getVisibility() == View.GONE) {
                                btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_light);
                            } else {
                                btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_menu_ios_center_light);
                                btnSelectOther.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_light);
                            }
                        } else {
                            btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_menu_ios_center_dark);
                            if (btnSelectOther.getVisibility() == View.GONE) {
                                btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_dark);
                            } else {
                                btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_menu_ios_center_dark);
                                btnSelectOther.setBackgroundResource(R.drawable.dialogx_button_dialog_ios_bottom_dark);
                            }
                        }
                    }
                    ...
                    if (okButtonDrawable == null && cancelButtonDrawable == null && otherButtonDrawable == null && theme == DialogSettings.THEME.LIGHT) {
                        btnSelectPositive.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_white);
                        btnSelectNegative.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_white);
                        btnSelectOther.setBackgroundResource(R.drawable.dialogx_button_selectdialog_square_white);
                    }
    ...
    public MessageDialog setStyle(DialogSettings.STYLE style) {
        ...
        switch (this.style) {
            case STYLE_IOS:
                build(this, R.layout.dialogx_layout_dialog_select_ios);
                break;
            case STYLE_SQUARE:
                build(this, R.layout.dialogx_layout_dialog_select);
                break;
            case STYLE_MATERIAL:
                build(this);
                break;
