...
import com.zndroid.dialogx.view.ActivityScreenShotImageView;
import com.zndroid.dialogx.view.BlurView;
import com.zndroid.dialogx.view.InterceptYLinearLayout;
...
public class FullScreenDialog extends BaseDialog {
    ...
    public static FullScreenDialog build(@NonNull AppCompatActivity context) {
        synchronized (FullScreenDialog.class) {
            ...
            fullScreenDialog.build(fullScreenDialog, R.layout.dialogx_layout_dialog_full_screen);
    ...
    public void bindView(View rootView) {
        ...
        if (theme == DialogSettings.THEME.LIGHT) {
            ...
            imgMaterialSlideBar.setBackgroundResource(R.drawable.dialogx_rect_share_material_tab);
            ...
            imgMaterialSlideBar.setBackgroundResource(R.drawable.dialogx_rect_share_material_tab_dark);
    ...
    public FullScreenDialog setStyle(DialogSettings.STYLE style) {
        ...
        this.style = style;
        build(this, R.layout.dialogx_layout_dialog_full_screen);
